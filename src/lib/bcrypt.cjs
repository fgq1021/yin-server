/**
 * 由于github国内不能直连，此为下载后改写的版本
 * 版本:5.1.1
 * 原项目地址 "https://github.com/kelektiv/node.bcrypt.js.git"
 */

const libPath = `./bcryptLib/${process.platform}-${process.arch}-${process.versions.libc || 'unknown'}.node`
const bindings = require(libPath)
